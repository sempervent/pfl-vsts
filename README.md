...
### PFL Pulse Colony (Stage 2 draft)

Deterministic generative **rhythmic gate** (AU/VST3): three PulseCells (ANCHOR / SKITTER / GHOST) propose into one ColonyArbiter → one gate/motion stream. Controls: MIX, DENSITY, MUTATION, MOTION, OUTPUT, SEED. Algorithm v2. Stage 1 Ableton PASS. See `docs/PULSE_COLONY.md`.
...
5. **PFL Pulse Colony** — Stage 1 COMPLETE; Stage 2 multi-cell colony in progress.
