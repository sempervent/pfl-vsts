...
**Stage 5 (in progress):** FREEZE / MUTATE / COLLAPSE / RESEED / SILENCE via `ConductorPerformanceController`. Freeze = lock evolution, continue pattern. Collapse = 24-beat MIDI descent. Projection union must hold under identical command timelines. Draft PR until Ableton acceptance.
