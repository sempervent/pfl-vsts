...
Ableton PASS. Tag `pulse-colony-stage1-complete`. See `docs/PULSE_COLONY.md`.

Stage 2 replaces the single cell with a proposal → ColonyArbiter → one gate/motion stream.
