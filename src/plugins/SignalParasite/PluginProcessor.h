...
class SignalParasiteProcessor final : public juce::AudioProcessor
{
public:
    SignalParasiteProcessor();
    ~SignalParasiteProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SignalParasiteProcessor)
};
